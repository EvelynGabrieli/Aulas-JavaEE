...
import br.com.senai.evelyngabrieli.model.Linguagem;

@SuppressWarnings("serial")
@RequestScoped //tempo de vida da pagina
@Named("cadastro") //nome do Bean ao qual vai ser renomeado para ficar mais facil e assim vai ser chamado
public class CadastroBean implements Serializable {
	...
	private Boolean receberEmails; //variaveis
	...
	public String getLinguagensAsString() {
		String str="";   
		boolean first = true;
		for(Integer linguagem  : linguagens) {   //serve para aparecer que as linguagens são strings, transformar no caso
			if(!first) {
				str=",";
			}
